    ...
    <div class="row">
        <div class="col-md-12" style="margin-top:100px;">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form autocomplete="off" action=" {{route('uytget_cak_temp',['cak_id'=>$cak->id])}}  " method="post" enctype="multipart/form-data">
...
{{--                            <input type="text" class="form-control" id="exampleInputEmail1" name="temp" placeholder="welaýatyň adyny üytget" value="{{$cak->temp}}">--}}
                            @php $i=1 @endphp
