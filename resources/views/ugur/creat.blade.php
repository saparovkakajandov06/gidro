    ...
    <div class="row">
        <div class="col-md-12" style="margin-top:100px;">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form autocomplete="off" action="{{route('creatugur.store')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
...
{{--<form action="{{route('creatugur.store')}}" method="post" enctype="multipart/form-data">--}}
{{--    {{csrf_field()}}--}}
