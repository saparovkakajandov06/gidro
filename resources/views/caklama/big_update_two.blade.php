                    ...
                    <tbody style="color: black; font-size: large;" >
                        ...
                        @foreach($welayat_caklamalar_two as $caklamas)
                                ...
                                <tr>
                                    ...
                                    <td align="center">{{ $caklamas->tizlik }}  {{ __('lang.ms') }}  </td>
                                    <td align="center">{{ $caklamas->cyg }} % </td>
                                    <td align="center"><a href=" {{route('editcak_two',['cak_id'=>$caklamas->id])}} "> <img src="{{asset('icon/1.png')}}" style="width: 30px;height: 30px;">   </a></td>
                                </tr>
                        @endforeach
                        <tr>
                            <th align="center"> {{ __('lang.edit') }} </th>
                            <td align="center"> <a href="{{route('edit_cak_howayagday_two',['cak_id'=>$caklamas->id])}}">  <img src="{{asset('icon/1.png')}}" style="width: 30px;height: 30px;"> </a></td>
                            <td align="center"> <a href="{{route('edit_cak_basys_two',['cak_id'=>$caklamas->id])}}">  <img src="{{asset('icon/1.png')}}" style="width: 30px;height: 30px;"> </a></td>
                            <td align="center"> <a href="{{route('edit_cak_temp_two',['cak_id'=>$caklamas->id])}}">  <img src="{{asset('icon/1.png')}}" style="width: 30px;height: 30px;"> </a> </td>
                            <td align="center"> <a href="{{route('edit_cak_ugur_two',['cak_id'=>$caklamas->id])}}">  <img src="{{asset('icon/1.png')}}" style="width: 30px;height: 30px;"> </a></td>
                            <td align="center"> <a href="{{route('edit_cak_tizlik_two',['cak_id'=>$caklamas->id])}}">  <img src="{{asset('icon/1.png')}}" style="width: 30px;height: 30px;"> </a> </td>
                            <td align="center"> <a href="{{route('edit_cak_cyg_two',['cak_id'=>$caklamas->id])}}">  <img src="{{asset('icon/1.png')}}" style="width: 30px;height: 30px;"> </a></td>
                        </tr>
