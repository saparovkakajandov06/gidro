    ...
    <div class="row">
        <div class="col-md-12" style="margin-top:100px;">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form autocomplete="off" action=" {{route('uytgettizlik',['how_id'=>$how->id])}}  " method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body" style="background-color: white;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="tizlik" placeholder="welaýatyň adyny üytget" value="{{$how->tizlik}}">
